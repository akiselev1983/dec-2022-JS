...
let users = [new User(1, 'olya', 'pupkin', 'olya@gmail.com', +380811111111),
             new User(22, 'anna', 'petrov', 'anna@gmail.com', +380822222222),
             new User(43, 'kolya', 'shevchenko', 'kolya@gmail.com', +380833333333),
             new User(14, 'ivan', 'pupkin', 'ivan@gmail.com', +380444444444),
             new User(35, 'max', 'ivanov', 'max@gmail.com', +380555555555),
             new User(16, 'kokos', 'nikolaev', 'kokos@gmail.com', +380866666666),
             new User(27, 'petya', 'trofimov', 'petya@gmail.com', +380877777777),
             new User(8, 'oleg', 'peregudov', 'oleg@gmail.com', +380888888888)
];
let user = new User(39, 'vasya', 'nechaev', 'vasya@gmail.com', +38089999999999);
users.push(user);
users.push(new User(10, 'petya', 'petuhov', 'petya1@gmail.com', +38081000000000));
console.log(users);
//======================================================================================================================
// - Взяти масив з  User[] з попереднього завдання, та відфільтрувати , залишивши тільки об'єкти з парними id (filter)
let filter = users.filter(u => u.id%2===0);
console.log(filter);
...
function Car(model, manufacturer, production, maxSpeed, engine) {
    this.model = model;
...
let car = new Car('Toyota', 'Japan', 2012, 190, 2.5);
console.log(car)
car.drive();
car.info();
...
class Car1 {
    ...
    info() {
        console.log(`model-${this.model}, manufacturer-${this.manufacturer}, production-${this.production}, maxSpeed-${this.maxSpeed}, engine-${this.engine}`)
    };
};
let car1 = new Car1('Toyota', 'Japan', 2012, 190, 2.5);
console.log(car1)
car1.info();
...
console.log(cinderellas.find(u => u.sizeFoot === prince.sizeFoot));
//======================================================================================================================