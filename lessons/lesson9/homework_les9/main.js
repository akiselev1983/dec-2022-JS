...
let ulsBlock = document.createElement('ul');
for (const item of menu) {
    let itemBlock = document.createElement('li');
    itemBlock.innerText = `${item}`;
    ulsBlock.append(itemBlock);
};
document.body.appendChild(ulsBlock);
...
for (const item of coursesAndDurationArray) {
    let itemBlock = document.createElement('h3');
...
for (const item of coursesAndDurationArray) {
    ...
    itemBlock.append(title, monthDuration);
...
for (const item of simpsons) {
    ...
    h3.innerText = `Age ${item.name} - ${item.age}`;
    let p = document.createElement('p');
    p.innerText = item.info;
    let photo = document.createElement('img');
    photo.setAttribute('src', item.photo);
    simpson.append(h2, h3, p, photo)
    document.body.appendChild(simpson)
};
//
// =====================================================================================================================
//     Цикл в циклі
